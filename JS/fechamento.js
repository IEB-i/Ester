...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('linkVoltar').href = `turmas.html`;
        ...
        inscritos.forEach(aluno => {
            ...
            tr.innerHTML = `
                <td class="col-nome" style="overflow: hidden;">
                    <div style="font-weight: 500; color: var(--text-main); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${aluno.nome_pessoa_cache}</div>
                </td>
                <td class="col-freq" style="text-align: center; font-weight: bold; color: ${freqColor};">${freqStr}</td>
                <td class="hide-on-mobile" style="color: var(--text-muted);">${sugStatus}</td>
