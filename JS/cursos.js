...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const inputSeguinte = document.getElementById('cursoSeguinte');
    ...
    function openModal(editData = null) {
        ...
        inputSeguinte.innerHTML = '<option value="">Nenhum</option>';
        ...
        cursosParaPreRequisito.forEach(c => {
            ...
            const optionSeguinte = document.createElement('option');
            optionSeguinte.value = c.id;
            optionSeguinte.textContent = c.nome;
            inputSeguinte.appendChild(optionSeguinte);
        });
        ...
        if (editData) {
            ...
            inputSeguinte.value = editData.proximo_curso_id || '';
        } else {
    ...
    function renderizarCursos() {
        ...
        listaCursos.forEach(curso => {
            ...
            const seg = curso.proximo_curso_id ? listaCursos.find(c => c.id === curso.proximo_curso_id) : null;
            const segNome = seg ? seg.nome : '';
            ...
            card.innerHTML = `
                ...
                <div class="course-meta" style="flex-wrap: wrap; row-gap: 8px;">
                    ...
                    ${segNome ? `<span title="Próximo Nível" style="color: var(--primary);"><i class="ph ph-arrow-right"></i> Vai para: ${segNome}</span>` : ''}
                </div>
    ...
    form.addEventListener('submit', async (e) => {
        ...
        const cursoData = {
            ...
            proximo_curso_id: inputSeguinte.value,
