...
import { getDocs, query, where, limit } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-firestore.js";
        ...
        listaTurmas.forEach(turma => {
            ...
            card.innerHTML = `
                ...
                <div class="turma-actions">
                    <button class="btn btn-secondary btn-editar" data-id="${turma.id}">
                        <i class="ph ph-pencil-simple"></i> Editar
                    </button>
                    <button class="btn btn-primary" onclick="window.location.href='inscricoes.html?id=${turma.id}'">
                        <i class="ph ph-user-plus"></i> Inscrições
                    </button>
                </div>
            `;
