...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    async function inicializarCalendario() {
        ...
        calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            selectable: true,
            eventDisplay: 'block', // Exibe como bloco preenchido

            // Customiza o conteúdo para garantir a exibição do texto
            eventContent: function(arg) {
                return {
                    html: `<div style="padding: 2px 4px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 0.85em; font-weight: 500; color: #ffffff; width: 100%;">
                        ${arg.event.title}
                    </div>`
                };
            },
